...
// RDPSND header: msgType=0x04 (SND_FORMATS), reserved=0, bodySize=40
0x04, 0x00, 0x28, 0x00,
// ServerFormats: dwFlags=0, dwVolume=0xFFFF, dwPitch=0, wDGramPort=0, wNumFormats=1, cLastBlockConfirmed=0, wVersion=6, bPad=0
0x00, 0x00, 0x00, 0x00,
0xFF, 0xFF, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x01, 0x00, // wNumFormats=1
0x00, 0x06, 0x00, 0x00, // version=6
...
// Channel header: totalLength=12, flags=0x03
0x0C, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00,
// RDPSND header: msgType=0x07 (SND_CLOSE), reserved=0, bodySize=0
0x07, 0x00, 0x00, 0x00,
}
