...
type SecurityConfig struct {
	...
	UseNLA             bool     `json:"useNLA" env:"USE_NLA" default:"false"`
}
...
func LoadWithOverrides(opts LoadOptions) (*Config, error) {
	...
	// NLA disabled by default for maximum compatibility; use --nla flag to enable
	config.Security.UseNLA = opts.UseNLA || getBoolWithDefault("USE_NLA", false)
